...
package com.wighawag.concurrency {
	...
	public class ThreadStatistics {
		...
		private var numInnerCycles : int;
		...
		public function toString() : String {
			return "Total Time: " + totalTime + "(ms)" + 
					...
					"\nAverage number of inner cycle: " + averageNumInnerCycle;
		}
		
		public function get averageNumInnerCycle() : Number {
			return numInnerCycles / numCycles; 
		}
		
		public function addInnerCycle():void 
		{
			numInnerCycles ++;
		}
